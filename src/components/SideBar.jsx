...
const SideBar = (props) => {
    ...
    return (
        <>
            <div className={`fixed right-0 top-0 z-20 bg-primary-light pt-5 w-56 h-screen transition-transform duration-500 ease-in-out ${collapsed ? "translate-x-full" : "translate-x-0"}`} >
